...
apiRouter.get(
  '/paragraphs',
  authMiddleware,
  ParagraphController.getMyParagraphs
);
apiRouter.get(
  '/paragraphs/:id',
  authMiddleware,
  ParagraphController.getParagraph
);
apiRouter.patch(
  '/paragraphs/:id',
  authMiddleware,
...
apiRouter.get(
  '/paragraphs/:id/words',
  authMiddleware,
  ParagraphController.getParagraphProperty
);
apiRouter.get(
  '/paragraphs/:id/characters',
  authMiddleware,
  ParagraphController.getParagraphProperty
);
apiRouter.get(
  '/paragraphs/:id/sentences',
  authMiddleware,
  ParagraphController.getParagraphProperty
);
apiRouter.get(
